...
const result = await requestJson(`${baseUrl}/v1/chat/completions`, {
  ...
  body: JSON.stringify({
    ...
    messages: [
      { role: "system", content: "You are a concise senior engineering assistant." },
      { role: "user", content: "Review this API integration plan and list the most likely production risks." },
    ],
    max_tokens: 600,
  }),
});
